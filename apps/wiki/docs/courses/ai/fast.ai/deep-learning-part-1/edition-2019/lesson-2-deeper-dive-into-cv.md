...
* [Lesson 2 video player](https://course.fast.ai/videos/?lesson=2)
...
![](/img/docs/fastai_p1_v3/lesson_2/1.png)

## Returning to work [[3:19]](https://youtu.be/Egp4Zajhzog?t=199)

![](/img/docs/fastai_p1_v3/lesson_2/41.png)

On the official course website, https://course-v3.fast.ai/ now has a "Returning to work" section which will show you (for each specific platform you use):
...
![](/img/docs/fastai_p1_v3/lesson_2/2.png)
...
![](/img/docs/fastai_p1_v3/lesson_2/3.png)
...
![](/img/docs/fastai_p1_v3/lesson_2/4.png)
...
![](/img/docs/fastai_p1_v3/lesson_2/5.png)
...
![](/img/docs/fastai_p1_v3/lesson_2/6.png)
...
![](/img/docs/fastai_p1_v3/lesson_2/7.png)
...
![](/img/docs/fastai_p1_v3/lesson_2/9.png)
...
![](/img/docs/fastai_p1_v3/lesson_2/10.png)
...
![](/img/docs/fastai_p1_v3/lesson_2/11.png)
...
![](/img/docs/fastai_p1_v3/lesson_2/12.png)
...
![](/img/docs/fastai_p1_v3/lesson_2/bears.png)
...
![](/img/docs/fastai_p1_v3/lesson_2/13.png)
...
![](/img/docs/fastai_p1_v3/lesson_2/14.png)
...
![](/img/docs/fastai_p1_v3/lesson_2/16.png)
...
![](/img/docs/fastai_p1_v3/lesson_2/17.png)
...
![](/img/docs/fastai_p1_v3/lesson_2/bear.png)
...
![](/img/docs/fastai_p1_v3/lesson_2/15.png)
...
![](/img/docs/fastai_p1_v3/lesson_2/18.png)
...
![](/img/docs/fastai_p1_v3/lesson_2/19.png)
...
![](/img/docs/fastai_p1_v3/lesson_2/20.png)
...
![](/img/docs/fastai_p1_v3/lesson_2/21.png)
...
![](/img/docs/fastai_p1_v3/lesson_2/22.png)

So then a question might be what is accuracy:

![](/img/docs/fastai_p1_v3/lesson_2/23.png)
...
![](/img/docs/fastai_p1_v3/lesson_2/24.png)
...
![](/img/docs/fastai_p1_v3/lesson_2/adam.gif)
...
![](/img/docs/fastai_p1_v3/lesson_2/25.png)
...
<a href='http://matrixmultiplication.xyz/' target='_blank'>![](/img/docs/fastai_p1_v3/lesson_2/matrix.png)</a>
...
![](/img/docs/fastai_p1_v3/lesson_2/matrix.gif)
...
![](/img/docs/fastai_p1_v3/lesson_2/26.png)
...
![](/img/docs/fastai_p1_v3/lesson_2/27.png)
...
We are going to jump into [lesson2-sgd.ipynb](https://nbviewer.jupyter.org/github/fastai/course-v3/blob/master/nbs/dl1/lesson2-sgd.ipynb). We are going to go bottom-up rather than top-down. We are going to create the simplest possible model we can which is going to be a linear model. And the first thing we need is we need some data. So we are going to generate some data. The data we're going to generate looks like this:
 ...
 ![](/img/docs/fastai_p1_v3/lesson_2/n1.png)
...
![](/img/docs/fastai_p1_v3/lesson_2/28.png)
...
![](/img/docs/fastai_p1_v3/lesson_2/29.png)
...
![](/img/docs/fastai_p1_v3/lesson_2/30.png)
...
![](/img/docs/fastai_p1_v3/lesson_2/31.png)
...
![](/img/docs/fastai_p1_v3/lesson_2/32.png)
...
![](/img/docs/fastai_p1_v3/lesson_2/n2.png)
...
![](/img/docs/fastai_p1_v3/lesson_2/35.png)
...
![](/img/docs/fastai_p1_v3/lesson_2/lr.gif)
...
![](/img/docs/fastai_p1_v3/lesson_2/38.png)
...
![](/img/docs/fastai_p1_v3/lesson_2/n3.png)
...
<video controls>
  <source src="/img/docs/fastai_p1_v3/lesson_2/download.mp4"/>
</video>
...
![](/img/docs/fastai_p1_v3/lesson_2/39.png)
...
![](/img/docs/fastai_p1_v3/lesson_2/rachel.png)
...
![](/img/docs/fastai_p1_v3/lesson_2/40.png)
