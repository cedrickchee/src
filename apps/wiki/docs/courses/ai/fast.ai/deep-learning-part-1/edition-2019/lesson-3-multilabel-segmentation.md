...
![](/img/docs/fastai_p1_v3/lesson_3/2.png)
...
![](/img/docs/fastai_p1_v3/lesson_3/3.png)
...
![](/img/docs/fastai_p1_v3/lesson_3/4.png)
...
|            |            |
| ---------- | ---------- |
| <img src="{require('/img/docs/fastai_p1_v3/lesson_3/5.png').default}" /><br /><a href="https://forums.fast.ai/t/share-your-work-here/27676/400">Guitar Classifier</a> by Christian Werner | <img src="{require('/img/docs/fastai_p1_v3/lesson_3/6.png').default}" /><br /><a href="https://forums.fast.ai/t/share-your-work-here/27676/340">Healthy or Not!</a> by Nikhil Utane |
| <img src="{require('/img/docs/fastai_p1_v3/lesson_3/7.png').default}" /><br /><a href="https://forums.fast.ai/t/share-your-work-here/27676/333">Hummingbird Classifier</a> by Nissan Dookeran | <img src="{require('/img/docs/fastai_p1_v3/lesson_3/8.png').default}" /><br /><a href="https://forums.fast.ai/t/share-your-work-here/27676/409">Edible Mushroom?</a> by Ramon |
| <img src="{require('/img/docs/fastai_p1_v3/lesson_3/9.png').default}" /><br /><a href="https://forums.fast.ai/t/share-your-work-here/27676/387">Cousin Recognizer</a> by Charlie Harrington | <img src="{require('/img/docs/fastai_p1_v3/lesson_3/10.png').default}" /><br /><a href="https://forums.fast.ai/t/share-your-work-here/27676/386">Emotion Classifier</a> by Ethan Sutin and Team 26 |
| <img src="{require('/img/docs/fastai_p1_v3/lesson_3/11.png').default}" /><br /><a href="https://forums.fast.ai/t/share-your-work-here/27676/350">American Sign Language</a> by Keyur Paralkar | <img src="{require('/img/docs/fastai_p1_v3/lesson_3/12.png').default}" /><br /><a href="https://forums.fast.ai/t/share-your-work-here/27676/355">Your City from Space</a> by Henri Palacci |
| <img src="{require('/img/docs/fastai_p1_v3/lesson_3/13.png').default}" /><br /><a href="https://forums.fast.ai/t/share-your-work-here/27676/367">Univariate time series as images using Gramian Angular Field</a> by Ignacio Oguiza | <img src="{require('/img/docs/fastai_p1_v3/lesson_3/14.png').default}" /><br /><a href="https://forums.fast.ai/t/share-your-work-here/27676/348">Face Expression Recognition</a> by Pierre Guillou |
| <img src="{require('/img/docs/fastai_p1_v3/lesson_3/15.png').default}" /><br /><a href="https://forums.fast.ai/t/share-your-work-here/27676/352">Tumor-normal sequencing</a> by Alena Harley |  |
...
![](/img/docs/fastai_p1_v3/lesson_3/planet.png)
...
![](/img/docs/fastai_p1_v3/lesson_3/16.png)
...
![](/img/docs/fastai_p1_v3/lesson_3/17.png)
...
![](/img/docs/fastai_p1_v3/lesson_3/18.png)
...
![](/img/docs/fastai_p1_v3/lesson_3/19.png)
...
![](/img/docs/fastai_p1_v3/lesson_3/mnist.png)
...
![](/img/docs/fastai_p1_v3/lesson_3/20.png)
...
![](/img/docs/fastai_p1_v3/lesson_3/21.png)
...
![](/img/docs/fastai_p1_v3/lesson_3/22.png)
...
![](/img/docs/fastai_p1_v3/lesson_3/23.png)
...
![](/img/docs/fastai_p1_v3/lesson_3/24.png)
...
![](/img/docs/fastai_p1_v3/lesson_3/25.png)
...
![](/img/docs/fastai_p1_v3/lesson_3/26.png)
...
![](/img/docs/fastai_p1_v3/lesson_3/27.png)
...
![](/img/docs/fastai_p1_v3/lesson_3/n1.png)
...
![](/img/docs/fastai_p1_v3/lesson_3/n2.png)
...
![](/img/docs/fastai_p1_v3/lesson_3/28.png)
...
![](/img/docs/fastai_p1_v3/lesson_3/29.png)
...
![](/img/docs/fastai_p1_v3/lesson_3/n3.png)
...
![](/img/docs/fastai_p1_v3/lesson_3/n4.png)
...
![](/img/docs/fastai_p1_v3/lesson_3/c1.png) ![](/img/docs/fastai_p1_v3/lesson_3/c2.png)
...
![](/img/docs/fastai_p1_v3/lesson_3/30.png)
...
![](/img/docs/fastai_p1_v3/lesson_3/c1.png)
...
![](/img/docs/fastai_p1_v3/lesson_3/c2.png)
...
![](/img/docs/fastai_p1_v3/lesson_3/c3.png)
...
![](/img/docs/fastai_p1_v3/lesson_3/c4.png)
...
![](/img/docs/fastai_p1_v3/lesson_3/c5.png)
...
**Announcement:** :loudspeaker: _there's been one change to fastai v1.0.29 (2018-11-27) and above—`Learner.create_unet` is now called `unet_learner`._
...
Yes, you should totally do that. It works great. This idea, it's something that I first came up with in the course a couple of years ago and I thought it seemed obvious and just presented it as a good idea, then I later discovered that nobody had really published this before. And then we started experimenting with it. And it was basically the main tricks that we use to win the [DAWNBench](https://dawn.cs.stanford.edu/benchmark/) ImageNet training competition.
...
![](/img/docs/fastai_p1_v3/lesson_3/31.png)
...
Good question. Remember from last week, if you're training loss is higher than your validation loss then you're **underfitting**. It definitely means that your underfitting. You want your training loss to be lower than your validation loss. If you're underfitting, you can:
...
![](/img/docs/fastai_p1_v3/lesson_3/u-net-architecture.png)
...
![](/img/docs/fastai_p1_v3/lesson_3/c6.png)

```python
learn.recorder.plot_lr()
```

![](/img/docs/fastai_p1_v3/lesson_3/c7.png)
...
![](/img/docs/fastai_p1_v3/lesson_3/jose1.gif)
...
![](/img/docs/fastai_p1_v3/lesson_3/jose2.gif)
...
![](/img/docs/fastai_p1_v3/lesson_3/jose4.gif)

Or if it's really too high, it diverges:

![](/img/docs/fastai_p1_v3/lesson_3/jose5.gif)
...
![](/img/docs/fastai_p1_v3/lesson_3/drawing1.gif)
...
![](/img/docs/fastai_p1_v3/lesson_3/drawing2.gif)
...
![](/img/docs/fastai_p1_v3/lesson_3/33.png)
...
![](/img/docs/fastai_p1_v3/lesson_3/c8.png)
...
![](/img/docs/fastai_p1_v3/lesson_3/c9.png)
...
![](/img/docs/fastai_p1_v3/lesson_3/34.png)
...
![](/img/docs/fastai_p1_v3/lesson_3/b1.png)
...
![](/img/docs/fastai_p1_v3/lesson_3/b0.png)
...
![](/img/docs/fastai_p1_v3/lesson_3/b2.png)
...
learn.recorder.plot()
```
![](/img/docs/fastai_p1_v3/lesson_3/b3.png)
...
![](/img/docs/fastai_p1_v3/lesson_3/b4.png)
...
1. **Tokenization**: it takes those words and converts them into a standard form of tokens. Basically each token represents a word.
   ...
   ![](/img/docs/fastai_p1_v3/lesson_3/35.png)
...
![](/img/docs/fastai_p1_v3/lesson_3/sagar.png)
